    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->label_id->setStyleSheet ("Font : 16pt");
    ui->label_id->setStyleSheet ("Font : bold");
    ui->label_age->setStyleSheet ("Font : 16pt");
    ui->label_age->setStyleSheet ("Font : bold");
    ui->label_prix->setStyleSheet ("Font : 16pt");
    ui->label_prix->setStyleSheet ("Font : bold");
    ui->label_nom->setStyleSheet ("Font : 16pt");
...
void MainWindow::on_Supprimer_clicked()
{
     ...
     addToHistory("suppression","d'un animal","");
...
void MainWindow::on_Supprimer_fiche_clicked()
{
   ...
   Fiche_animal a(1,1,1,1,1,"","","");
     ...
     addToHistory("suppression","d'une fiche animal","");
